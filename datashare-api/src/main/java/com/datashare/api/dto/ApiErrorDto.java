...
public class ApiErrorDto {
   ...
   */
  public static ApiErrorDto of(int status, String message, String path) {
    return new ApiErrorDto(status, message, path, LocalDateTime.now());
  }
   ...
   */
  public static ApiErrorDto of(int status, String message, WebRequest request) {
    return ApiErrorDto.of(status, message, request.getDescription(false).replace("uri=", ""));
  }
}
